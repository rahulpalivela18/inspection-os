      ...
      <div className="p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage your inspections and client reports.</p>
          </div>
          
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button size="lg" className="shadow-lg shadow-primary/20 transition-all hover:scale-[1.02]">
            ...
            {filteredProjects.map((project: any) => (
              ...
              >
                ...
                <CardContent className="pb-3">
                  ...
                  <div className="flex items-center gap-2 mt-4 text-xs text-muted-foreground font-medium bg-secondary/50 p-2 rounded-md w-fit">
                    <span className="text-primary font-bold">Client:</span> {project.clientName}
                  </div>
                </CardContent>
