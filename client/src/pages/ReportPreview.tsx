...
export default function ReportPreview({
  ...
  const inspectionTypes = Array.isArray(report.inspectionType) ? report.inspectionType : [report.inspectionType || "Home Inspection"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t-2 border-slate-900 pt-8">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-xl md:text-2xl font-black text-slate-900">{report.author}</p>
              </div>
            </div>
          </div>
        </div>
