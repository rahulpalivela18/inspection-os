...
export default function ReportPreview({
  ...
  function PDFPage({ children, className = "" }: { children: React.ReactNode; className?: string }) {
    return (
      <div
        className={`relative isolate bg-white break-after-page ${className}`}
        style={{
          width: "210mm",
          minHeight: "297mm",
          contain: "layout",
              ...
              <div>
                ...
                {issue.images.length === 3 && (
                  ...
                  >
                    <div
                      className="rounded-2xl border border-slate-200 overflow-hidden bg-slate-50"
                      style={{ height: "85mm", gridColumn: "1 / -1" }}
                    >
                      <img
                        src={issue.images[0]}
                        className="w-full h-full object-cover"
                              ...
                              {itemAfterPhotos.length === 0 ? (
                                ...
                                <div className="grid grid-cols-2 gap-0.5 bg-slate-100 p-0.5">
                                  {itemAfterPhotos.map((photo, pIdx) => (
                                    <div key={pIdx} className="bg-emerald-50/30" style={{ height: "72mm" }}>
                  ...
                  <div className="border-t-2 border-slate-900 pt-8 mt-auto">
                    ...
                    <div className="mt-8 border-t border-slate-200 pt-4 text-center">
                      <p className="text-[9px] font-bold uppercase tracking-widest text-slate-400">
                        End of Report · Report generated by Inspection OS © {new Date().getFullYear()}
                      </p>
                    </div>
                  </div>
                </div>
