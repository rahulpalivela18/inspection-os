...
export default function ReportPreview({ report, project, issues }: ReportPreviewProps) {
  return (
    <div className="font-sans text-sm text-slate-900 leading-normal bg-white print:p-0">
      {/* Cover Page */}
      <div className="h-[296mm] flex flex-col p-[20mm] bg-white break-after-page relative overflow-hidden border-b print:border-0">
        ...
        <div className="flex justify-between items-start mb-24">
          ...
          {project.logoUrl && (
            <div className="w-32 h-32 p-4 border border-slate-100 rounded-2xl bg-white shadow-sm flex items-center justify-center overflow-hidden">
              <img 
                src={project.logoUrl} 
                alt="Client Logo" 
        ...
        <div className="mt-24 pt-8 border-t border-slate-100 flex justify-between items-center text-slate-400 text-xs font-medium">
      ...
      <div className="p-[15mm] bg-white min-h-[297mm]">
        <div className="border-b-2 border-slate-900 pb-4 mb-8 flex justify-between items-center">
          ...
          <span className="text-slate-400 text-xs font-bold uppercase tracking-widest">Section 01 / Technical Observations</span>
        </div>
      ...
      {/* Summary Footer */}
      <div className="p-[15mm] text-center border-t border-slate-100 mt-auto bg-white">
