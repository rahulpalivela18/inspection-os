export const DEFAULT_CHECKLIST_POINTS: Array<{
  ...
  { category: "Bathroom", point: "Flooring (Tiles): Any colour & shade variation observed in tiles", isRepeatable: true, spaceType: "bathroom", triggerOn: "yes" },
  ...
  { category: "Bathroom", point: "Waterproofing: Any seepage or dampness observed on walls/ceiling", isRepeatable: true, spaceType: "bathroom", triggerOn: "yes" },
  ...
  { category: "Balcony", point: "Flooring (Tiles): Any colour & shade variation observed in floor tiles", isRepeatable: true, spaceType: "balcony", triggerOn: "yes" },
  { category: "Balcony", point: "Flooring (Tiles): Hollowness or debonding observed in floor tiles after fixing", isRepeatable: true, spaceType: "balcony", triggerOn: "yes" },
  ...
  { category: "Common Area", point: "Walls: Any dampness or seepage observed on walls", isRepeatable: false, triggerOn: "yes" },
  { category: "Common Area", point: "Ceiling: Any dampness or seepage observed on ceiling", isRepeatable: false, triggerOn: "yes" },
  ...
  { category: "External Area", point: "Modular Kitchen: Is the kitchen countertop free from chips and cracks", isRepeatable: false, triggerOn: "yes" },
  { category: "External Area", point: "External Walls: Any cracks or dampness observed on external walls", isRepeatable: false, triggerOn: "yes" },
  { category: "External Area", point: "Waterproofing: Any water seepage observed from terrace/external walls", isRepeatable: false, triggerOn: "yes" },
];
